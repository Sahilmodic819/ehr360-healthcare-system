// frontend/src/pages/Auth/DoctorRegister.jsx
import React, { useState } from 'react';
import { useNavigate, Link } from 'react-router-dom';
import api from '../../utils/api';

export default function DoctorRegister(){
  const [form,setForm] = useState({ fullName:'', email:'', aabhaId:'', aadharNo:'', phone:'', nmcRegNo:'', password:'', confirmPassword:''});
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const res = await api.post('/api/auth/register/doctor', form);
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="flex justify-center space-x-4 mb-6 text-sm">
            ...
            <span className="text-blue-600 font-medium border-b-2 border-blue-600 pb-1">Doctor</span>
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div>
              <label className="block text-gray-700 font-medium mb-2">NMC Registration No.</label>
              <input className="input w-full" name="nmcRegNo" value={form.nmcRegNo} onChange={e=>setForm({...form,nmcRegNo:e.target.value})} required />
            </div>
            <div>
